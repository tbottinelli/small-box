...
def main():
    ...
    #rdf0 = interp1d(xgrid, mean_pressure[0,:] ,bounds_error=False, kind = 'quadratic')
    rdf1 = interp1d(xgrid, mean_pressure[:] ,bounds_error=False, kind = 'quadratic')
